    ...
    return (
      <div className='flex h-full w-full items-center justify-center p-8'>
        <div className='text-center'>
          ...
          <p className='text-sm font-medium text-gray-900'>Error loading PDF</p>
    ...
    <div className='flex h-full w-full items-center justify-center'>
      ...
      >
        <Page
          pageNumber={1}
          width={
            width > 600 ? 600 - PDF_VIEWER_PADDING : width - PDF_VIEWER_PADDING
          }
...
export default function InvoicePreview({ invoiceData }: InvoicePreviewProps) {
  ...
  return (
    <div
      ref={containerRef}
      className='hide-scrollbar h-full w-full overflow-y-auto bg-secondary shadow-[2px_2px_4px_rgba(0,0,0,0.15),-1px_-1px_3px_rgba(255,255,255,0.01)] dark:shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.02)]'
    >
