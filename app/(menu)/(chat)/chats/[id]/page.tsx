                              ...
                              <div className='flex flex-row items-center justify-center'>
                                <Dialog>
                                  <DialogTrigger className='px-3 py-1 cursor-pointer'>
                                    <div
                                      className={cn(
                                        'w-full text-xs hover:bg-primary-foreground/20 flex flex-row items-center p-2 rounded-lg'
                                      )}
                                    >
                                      <Paperclip className='w-3 h-3 mr-1' />
                                      Attach Files
                                  ...
                                  <DialogContent>
                                    <DialogHeader>
                                      ...
                                      <DialogDescription>
                                        Un-authorised user can't upload assets,
                                        you have to signup for that
                                      </DialogDescription>
                                    </DialogHeader>
                                    <button
                                      onClick={async () => {
